...
# Form implementation generated from reading ui file 'Pseudonym_dark.ui'
#
...
class Ui_Pseudonym(object):
    def setupUi(self, Pseudonym):
        ...
        self.stones_label.setStyleSheet("background-color: none;\n"
                                        "color: #b7b7b7")
        ...
        self.takeInput_label.setStyleSheet("background-color: none;\n"
                                           "color: #b7b7b7")
