...
# Form implementation generated from reading ui file 'AntiPlagiarism_dark.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.text1_label.setStyleSheet("background-color: none;\n"
"color: #b7b7b7")
...
"}")
        ...
        self.alert_label.setGeometry(QtCore.QRect(10, 20, 224, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.alert_label.setStyleSheet("background-color: none;\n"
"color: #b7b7b7")
...
"")
        ...
        self.text2_label.setStyleSheet("background-color: none;\n"
"color: #b7b7b7")
